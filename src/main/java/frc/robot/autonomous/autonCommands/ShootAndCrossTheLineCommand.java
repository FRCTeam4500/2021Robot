...
public class ShootAndCrossTheLineCommand extends SequentialCommandGroup {
    public ShootAndCrossTheLineCommand(OdometricSwerve swerve, Shooter shooter, Indexer indexer){
